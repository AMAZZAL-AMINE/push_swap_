...
/*   Updated: 2023/04/13 21:13:23 by mamazzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	check_if_rand_big();
	while (s_args.stack_a[s_args.arr_size - 1] <= var.arr[var.range_max] \
		&& s_args.stack_a[s_args.arr_size - 1] >= var.arr[var.range_min])
	{
